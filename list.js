...
class List extends Component {
    ...
    bind = (event) => {
        ...
        /* fungsi ini digunakan unutk memasukkan data dari elemen input ke variabel state.
            contoh ketika input nis diisi, maka secara otomatis variabel nis pada state bernilai
            sesuai dg inputan
        */
    }
